...
extern struct linop_s* linop_chainAdj(const struct linop_s* a, const struct linop_s* b); // added
extern struct linop_s* linop_chainNormal(const struct linop_s* a, const struct linop_s* b); // added
struct linop_s* linop_PutFowrardOfBInNormalOfA(const struct linop_s* a, const struct linop_s* b); // added
