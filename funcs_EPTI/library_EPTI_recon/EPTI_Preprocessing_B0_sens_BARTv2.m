function [sens_map_all,P_dB_all,Phase0_odd_all,Phase0_even_all,gccmtx_aligned,im_GRE_combo] = EPTI_Preprocessing_B0_sens_BARTv2(directory,filename,kdata_calib0,parameters,parameters_calib,save_data_flag,coilcompression_flag) 
