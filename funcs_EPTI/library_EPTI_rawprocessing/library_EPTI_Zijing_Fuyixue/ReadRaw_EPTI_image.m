function [kdata,k_nav,parameters,linear_fit_coeff] = ReadRaw_EPTI_image(filename,parameters,dyn,process_type,seq_type,gccmtx_aligned,linear_fit_coeff)
...
switch process_type
    case 0  % 0: GE only
        ...
        if seq_type == 0 % zigzag/single-shot version
            kdata = putRawtoPattern_SMS_zigzag_PF_selfnav(kdata,parameters.Nseg,parameters.Rseg,parameters.Rpe,parameters.SMS_shift,parameters.PF_shift);
