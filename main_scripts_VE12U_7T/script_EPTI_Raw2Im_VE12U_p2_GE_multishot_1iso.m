...
filename_calib = fullfile(directory,'meas_MID00511_FID119293_EPTI_p2_calibration_1iso.dat');    % path for rawdata file of the calibration scan
filename_EPTI = fullfile(directory,'meas_MID00513_FID119295_EPTI_p2_5shot_GE_1iso.dat');        % path for rawdata file of the imaging scan
save_filename = 'EPTI_p2_5shot_GE_1iso';                                                        % filename for output data
...
StartEcho_forPhasecor = 5;                  % start from which echo in calibration data to calculate odd-even echo phase difference for all echoes (skip early echoes which may have strong variation at 7T)
