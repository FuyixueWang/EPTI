...
filename_calib = fullfile(directory,'meas_MID00534_FID119316_EPTI_p1_calibration_2iso.dat');    % path for rawdata file of the calibration scan
filename_EPTI = fullfile(directory,'meas_MID00536_FID119318_EPTI_p1_singleshot_GE_2iso.dat');   % path for rawdata file of the imaging scan
save_filename = 'EPTI_p1_singleshot_GE_2iso';                                                   % filename for output data
...
Dyn_Dummy = 5;          % the number of early dynamcis to skip as dummy scans which have not reached steady state
