...
filename_calib = fullfile(directory,'meas_MID00515_FID119297_EPTI_p3_calibration_1x1x2.dat');   % path for rawdata file of the calibration scan
filename_EPTI = fullfile(directory,'meas_MID00517_FID119299_EPTI_p3_5shot_SE_1x1x2.dat');       % path for rawdata file of the imaging scan
save_filename = 'EPTI_p3_5shot_SE_1x1x2';                                                       % filename for output data
