...
filename_calib = fullfile(directory,'meas_MID00172_FID17043_EPTI_p1_calibration_3iso.dat');   % path for rawdata file of the calibration scan
filename_EPTI = fullfile(directory,'meas_MID00174_FID17045_EPTI_p1_singleshot_GE_3iso.dat');  % path for rawdata file of the imaging scan
save_filename = 'EPTI_p1_singleshot_GE_3iso';                                                 % filename for output data
...
if recon_algorithm.regularization == 1
    ...
    recon_algorithm.block_size = 6;         % block size for LLR
end
