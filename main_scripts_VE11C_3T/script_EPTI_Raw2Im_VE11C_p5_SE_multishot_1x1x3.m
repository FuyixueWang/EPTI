...
filename_calib = fullfile(directory,'meas_MID00184_FID17055_EPTI_p5_calibration_1x1x3mm.dat');    % path for rawdata file of the calibration scan
filename_EPTI = fullfile(directory,'meas_MID00186_FID17057_EPTI_p5_5shot_SE_1x1x3mm.dat');        % path for rawdata file of the imaging scan
save_filename = 'EPTI_p5_5shot_SE_1x1x3';                                                         % filename for output data
