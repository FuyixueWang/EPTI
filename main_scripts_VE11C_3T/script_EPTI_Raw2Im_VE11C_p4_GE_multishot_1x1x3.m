...
filename_calib = fullfile(directory,'meas_MID00180_FID17051_EPTI_p4_calibration_1x1x3mm.dat');    % path for rawdata file of the calibration scan
filename_EPTI = fullfile(directory,'meas_MID00182_FID17053_EPTI_p4_5shot_GE_1x1x3mm.dat');        % path for rawdata file of the imaging scan
save_filename = 'EPTI_p4_5shot_GE_1x1x3';                                                         % filename for output data
