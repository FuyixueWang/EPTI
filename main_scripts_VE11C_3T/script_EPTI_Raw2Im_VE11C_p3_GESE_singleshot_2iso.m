...
filename_calib = [directory,'meas_MID00212_FID17083_EPTI_p3_calibration_2iso.dat'];   % path for rawdata file of the calibration scan
filename_EPTI = [directory,'meas_MID00214_FID17085_EPTI_p3_singleshot_GESE_2iso.dat']; % path for rawdata file of the imaging scan
save_filename0 = 'EPTI_p3_singleshot_GESE_2iso';  % filename for output data
...
recon_algorithm.apodize_factor = 0.15;      % apodization factor
...
for process_index = 1:length(process_type_use)
    ...
    if process_type == 0
        ...
        if recon_algorithm.regularization == 1
            ...
            recon_algorithm.lambda = 5e-4;      % lambda for regularization
